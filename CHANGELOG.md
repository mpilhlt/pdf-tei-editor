...
* **build:** use a free port and kill the whole server group in generate-client ([df65830](https://github.com/mpilhlt/pdf-tei-editor/commit/df658307e2eabba7a43b7e319efef9df215defab))
