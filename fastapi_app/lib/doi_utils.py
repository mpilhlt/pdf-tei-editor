...
BIBLIOGRAPHIC_METADATA_PROMPT = """Extract bibliographic metadata from this document.
...
Return the information as JSON matching the expected schema. Only include fields where you can find the information."""
