...
from fastapi_app.plugins.webdav_sync.remote_metadata import RemoteMetadataManager, REMOTE_SCHEMA
...
class TestRemoteMetadataManager(unittest.TestCase):
    ...
    @patch('fastapi_app.plugins.webdav_sync.remote_metadata.WebdavFileSystem')
