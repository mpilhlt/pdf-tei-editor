...
ANNOTATION_TAGS: AnnotationTagsMap = {
    ...
    "grobid.training.references.referenceSegmenter": [
        ...
        },
        {
            ...
            "color": "#f9e2af",
            "priority": 4,
            "defaultAttributes": {"type": "decision"},
            "description": "A court ruling / judicial decision citation",
            "childTags": ["label"],
        },
        {
            "tag": "bibl",
            "label": "bibl[legislation]",
            "color": "#fab387",
            "priority": 5,
            "defaultAttributes": {"type": "legislation"},
            "description": "A statute / legislation citation",
            "childTags": ["label"],
        },
    ],
    "grobid.training.references": [
        {
            ...
            "description": "An individual bibliographic reference",
            "childTags": [
                "author", "title", "date", "biblScope", "publisher", "edition",
        ...
        },
        {
            ...
            "color": "#f2cdcd",
            "priority": 23,
            "defaultAttributes": {"level": "m", "type": "legislation"},
            "description": "Title of a statute / legislative act",
            "attributes": [{"name": "key", "values": []}],
        },
        {
            "tag": "title",
            ...
            "color": "#eba0ac",
            "priority": 24,
            "defaultAttributes": {"level": "a", "type": "caseName"},
            "description": "Case name of a court ruling",
        },
        {
            "tag": "date",
            "label": "date[decision]",
            ...
            "priority": 25,
            "defaultAttributes": {"type": "decision"},
            "description": "Date a court decision was rendered",
        },
        {
            "tag": "date",
            "label": "date[enacted]",
            "color": "#b4befe",
            "priority": 26,
            "defaultAttributes": {"type": "enacted"},
            "description": "Date a statute was enacted",
        },
        {
            "tag": "orgName",
            "label": "orgName[court]",
            "color": "#585b70",
            "priority": 27,
            "defaultAttributes": {"type": "court"},
            "description": "Court issuing a decision",
        },
        {
            "tag": "citedRange",
            "label": "citedRange[section]",
            "color": "#89b4fa",
            "priority": 28,
            "defaultAttributes": {"unit": "section"},
            "description": "Cited section of a statute or decision",
            "attributes": [{"name": "unit", "values": [
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[sub-section]",
            "color": "#a6e3a1",
            "priority": 29,
            "defaultAttributes": {"unit": "sub-section"},
            "description": "Cited sub-section of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[sentence]",
            "color": "#74c7ec",
            "priority": 30,
            "defaultAttributes": {"unit": "sentence"},
            "description": "Cited sentence of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[number]",
            "color": "#fab387",
            "priority": 31,
            "defaultAttributes": {"unit": "number"},
            "description": "Cited numbered item of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[letter]",
            "color": "#f9e2af",
            "priority": 32,
            "defaultAttributes": {"unit": "letter"},
            "description": "Cited lettered item of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[margin]",
            "color": "#94e2d5",
            "priority": 33,
            "defaultAttributes": {"unit": "margin"},
            "description": "Cited margin number of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[recital]",
            "color": "#cba6f7",
            "priority": 34,
            "defaultAttributes": {"unit": "recital"},
            "description": "Cited recital of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        {
            "tag": "citedRange",
            "label": "citedRange[page]",
            "color": "#f5c2e7",
            "priority": 35,
            "defaultAttributes": {"unit": "page"},
            "description": "Cited page of a statute or decision",
            "attributes": [{"name": "unit", "values": [
                "section", "sub-section", "sentence", "number",
                "letter", "margin", "recital", "page",
            ]}],
        ...
        },
        {
            ...
            "attributes": [{"name": "type", "values": ["DOI", "arXiv", "report", "docket", "ECLI", "CELEX"]}],
        },
        {
            "tag": "note",
            "label": "note",
