    ...
    "grobid.training.references": [
        {
            ...
            "childTags": [
                ...
                "orgName", "pubPlace", "editor", "ptr", "idno", "note", "citedRange", "seg",
            ],
        },
        {
            "tag": "bibl",
        ...
        },
        {
            ...
            "priority": 26,
            "defaultAttributes": None,
            "description": "Pinpoint into a statute or decision (section, subsection, marginal number, etc.)",
        ...
        },
        {
            ...
            "color": "#9399b2",
            "priority": 27,
            "defaultAttributes": {"type": "signal"},
            "description": "Discourse signal word introducing or framing a citation (e.g. 'see', 'vgl.', 'cf.')",
        },
        {
            "tag": "author",
            "label": "author",
        ...
        },
        {
            ...
            "attributes": [{"name": "type", "values": ["decision", "enacted"]}],
        },
        {
            "tag": "biblScope",
            "label": "pages",
