...
- **CI/CD Workflow Changes** - ALWAYS consult [docs/code-assistant/ci.md](docs/code-assistant/ci.md) before modifying GitHub Actions workflows. The document describes the test execution strategy, release process, and dependencies between workflows
