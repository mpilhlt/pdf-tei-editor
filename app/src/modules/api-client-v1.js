 ...
 *
 * Generated from OpenAPI schema at 2025-12-15T14:06:37.796Z
 *
...
export class ApiClientV1 {
   ...
   *
   * @param {Object=} params - Query parameters
   * @param {string} params.pdf
   * @param {string=} params.variant
   * @returns {Promise<any>}
   */
  async pluginsAnnotationVersionsAnalyzerExport(params) {
    const endpoint = `/plugins/annotation-versions-analyzer/export`
    return this.callApi(endpoint, 'GET', params);
  }
