...
#
# This file demonstrates how to use scripts/deploy/deploy.js for automated deployments.
#
# Usage:
#   node scripts/deploy/deploy.js .env.example.org
#   node scripts/deploy/deploy.js /path/to/custom.env
#
# Or with sudo for nginx/SSL:
#   sudo env "PATH=$PATH" node scripts/deploy/deploy.js .env.example.org
#
# Variable Categories:
# ====================
#
